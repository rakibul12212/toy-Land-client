...
<nav className="bg-slate-300 border-gray-200 dark:bg-gray-900 sticky z-100 top-0">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4  md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <NavLink to="/" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>Home</NavLink>
      </li>
      <li>
        <NavLink to="alltoys" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>All Toys</NavLink>
      </li>
      <li>
        <NavLink to="/addatoy" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>Add A Toy</NavLink>
      </li>
      <li>
        <NavLink to="/mytoys" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>My Toys</NavLink>
      </li>
      <li>
        <NavLink to="/blogs" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>Blogs</NavLink>
      </li>
      <li>
        <NavLink to="/aboutus" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>About Us</NavLink>
      </li>
      <li>
        <NavLink to="/contactus" className={({ isActive }) => (isActive ? 'active-link' : "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500")}>Contact Us</NavLink>
      </li>
    </ul>
  </div>
  </div>
